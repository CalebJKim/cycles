...
import { Button, Dialog, DialogContent, Divider, IconButton, LinearProgress, Paper, Stack, Typography } from '@mui/material';
            ...
            {personaData.map((persona, index) => (
              <React.Fragment key={index}>
                <Stack direction="row" justifyContent="space-between" alignItems="center" sx={{ mb: 1 }}>
                  <Typography variant="subtitle1" sx={{ lineHeight: 1.6 }}>Persona {index + 1}</Typography>
                  <Typography variant="subtitle1" sx={{ lineHeight: 1.6 }}>{persona.score}% Positive</Typography>
                </Stack>
                <Stack direction="row" alignItems="center" spacing={2} sx={{ mb: 1 }}>
                  <Typography variant="subtitle1" sx={{ fontWeight: 'bold', flexGrow: 1, lineHeight: 1.6 }}>
                    {persona.title}
                  </Typography>
                  <LinearProgress
                    variant="determinate"
                ...
                <Typography variant="body2" sx={{ lineHeight: 1.6, mt: ".5rem", mb: "1rem" }}>
                  {persona.description}
                </Typography>
